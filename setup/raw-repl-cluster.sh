...
configure_alluxio(){
	...
	flintrock run-command $cluster_name 'echo "fr.repl.interval=60" >> /home/ec2-user/alluxio/conf/alluxio-site.properties; echo "fr.repl.weight=1" >> /home/ec2-user/alluxio/conf/alluxio-site.properties; echo "fr.record.interval=0.5" >> /home/ec2-user/alluxio/conf/alluxio-site.properties;'

	# flintrock rn-command $cluster_name 'echo "fr.repl.policy.class = " >> /home/ec2-user/alluxio/conf/alluxio-site.properties;
